...
ent-ReinforcementRadioSyndicateCyborgAssault = радио подкрепления киборгов Синдиката
    .desc = Призовите любого из трёх хорошо вооруженных киборгов на ваш вкус, немедленно!
    .suffix = Ядерные оперативники
