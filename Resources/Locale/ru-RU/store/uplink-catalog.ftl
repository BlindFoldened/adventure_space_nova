...
uplink-reinforcement-radio-cyborg-assault-name = Телепорт киборгов Синдиката
uplink-reinforcement-radio-cyborg-assault-desc = Призовите на помощь зловещую силиконовую боевую единицу, способную заменить недостающее звено в вашей команде.
